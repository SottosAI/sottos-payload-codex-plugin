...
- Upload the generated image as-is unless it exceeds 12MB. Do not downscale or recompress first; `uploadMedia` normalizes covers server-side to 1600x1000 WebP.
